...
class CustomUser(AbstractBaseUser):
    ...
    def __str__(self):
        ...
        """
        return f"'id': {self.id}, 'first_name': '{self.first_name}', 'middle_name': '{self.middle_name}', 'last_name': '{self.last_name}', 'email': '{self.email}', 'role': {self.role}, 'is_active': {self.is_active}"  # 'password': '{self.password}'
